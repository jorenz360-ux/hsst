                    ...
                    <table class="w-full text-left text-sm">
                        <thead class="border-b border-white/10 bg-zinc-950/80 text-zinc-400">
                            <tr>
                                ...
                                <th class="px-4 py-3 font-medium">Alumni Name</th>
                                <th class="px-4 py-3 font-medium">RSVP Status</th>
                                <th class="px-4 py-3 font-medium">Event Fee</th>
                        ...
                        <tbody class="divide-y divide-white/10">
                            @if ($selectedEvent === 'all')
                                <tr>
                                    <td colspan="7" class="px-6 py-14 text-center text-sm text-zinc-500">
                            ...
                            @else
                                @forelse ($participants as $participant)
                                    ...
                                    <tr class="transition hover:bg-emerald-500/[0.04]">
                                        <td class="px-4 py-3 text-zinc-300">{{ $participant->batch_label ?: '—' }}</td>

                                        <td class="px-4 py-3 text-zinc-100">{{ $fullName ?: '—' }}</td>
